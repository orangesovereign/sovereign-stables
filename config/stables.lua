...
Config.Stables = {
    ...
    ['rhodes'] = {
        ...
        blip = {
            enabled = true,
            sprite  = 1938782895,
            coords  = { 1431.99, -1288.96, 77.77 },   -- on the stablehand
        },
        ped = {
            enabled  = true,
            model    = 'u_m_m_bwmstablehand_01',
            coords   = { 1431.99, -1288.96, 77.77, 299.44 },   -- Ped Coords
            scenario = 'WORLD_HUMAN_WAITING_IMPATIENT',
            grooming = {
                enabled  = true,
                horsePos = { 1432.63, -1288.75, 77.77, 17.54 },   -- Horse Ped Coords
                breeds   = nil,
            },
        },
        -- On the stablehand — matches ped.coords, so the prompt opens the stable.
        prompt = { coords = { 1431.99, -1288.96, 77.77 }, distance = 1.5 },
        preview = {
            horsePos = { 1446.31, -1283.63, 77.78, 24.85 },   -- Preview Horse Coords
            wagonPos = { 1453.82, -1314.18, 75.84, 62.76 },   -- Preview Wagon Coords
        },
        -- OUTSIDE and clear — the wagon you drive away, and the R put-away spot.
        retrieve = {
            wagonPos = { 1421.22, -1289.0, 77.88, 165.79 },   -- Wagon Spawn / Put Away
        },
        jobs = { restricted = false, allowed = {} },
        faction = { enabled = false, job = nil },
        catalog = { horses = {}, wagons = {} },
    ...
    ['tumbleweed'] = {
        ...
        blip = {
            enabled = true,
            sprite  = 1938782895,
            coords  = { -5514.56, -3042.16, -2.44 },   -- on the stablehand
        },
        ped = {
            enabled  = true,
            model    = 'u_m_m_bwmstablehand_01',
            coords   = { -5514.56, -3042.16, -2.44, 186.03 },   -- Ped Coords
            scenario = 'WORLD_HUMAN_WAITING_IMPATIENT',
            grooming = {
                enabled  = true,
                horsePos = { -5513.83, -3042.72, -2.44, 262.99 },   -- Horse Ped Coords
                breeds   = nil,
            },
        },
        -- On the stablehand — matches ped.coords, so the prompt opens the stable.
        prompt = { coords = { -5514.56, -3042.16, -2.44 }, distance = 1.5 },
        preview = {
            horsePos = { -5540.71, -3038.6, -1.33, 5.02 },     -- Preview Horse Coords
            wagonPos = { -5551.95, -3034.18, -1.23, 10.23 },   -- Preview Wagon Coords
        },
        -- OUTSIDE and clear — this is the wagon you actually drive away (and the
        -- R put-away spot; owner captured them as one point).
        retrieve = {
            wagonPos = { -5562.38, -3036.57, -0.91, 6.97 },    -- Wagon Spawn / Put Away
        },
        jobs = { restricted = false, allowed = {} },
        faction = { enabled = false, job = nil },
        catalog = { horses = {}, wagons = {} },
    ...
    ['vanhorn'] = {
        ...
        blip = {
            enabled = true,
            sprite  = 1938782895,
            coords  = { 2968.89, 797.66, 51.35 },   -- on the stablehand
        },
        ped = {
            enabled  = true,
            model    = 'u_m_m_bwmstablehand_01',
            coords   = { 2968.89, 797.66, 51.35, 6.64 },   -- Ped Coords
            scenario = 'WORLD_HUMAN_WAITING_IMPATIENT',
            grooming = {
                enabled  = true,
                horsePos = { 2968.89, 798.32, 51.35, 88.84 },   -- Horse Ped Coords
                breeds   = nil,
            },
        },
        -- On the stablehand — matches ped.coords, so the prompt opens the stable.
        prompt = { coords = { 2968.89, 797.66, 51.35 }, distance = 1.5 },
        preview = {
            horsePos = { 2987.78, 783.63, 50.09, 7.68 },     -- Preview Horse Coords
            wagonPos = { 2949.84, 765.89, 51.36, 303.42 },   -- Preview Wagon Coords
        },
        -- OUTSIDE and clear — the wagon you drive away, and the R put-away spot.
        retrieve = {
            wagonPos = { 2945.92, 784.34, 51.35, 46.18 },   -- Wagon Spawn / Put Away
        },
        jobs = { restricted = false, allowed = {} },
        faction = { enabled = false, job = nil },
        catalog = { horses = {}, wagons = {} },
